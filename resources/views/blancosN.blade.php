        ...
        <div class="card">
          <div class="card-body">
              ...
              <div class="input-group mb-3">
                  ...
                  <input type="text" class="col-md-4 form-control" placeholder="Inserte una descripcion" aria-label="Username" aria-describedby="basic-addon1">
              ...
              <div class="input-group mb-3">
                  ...
                  <input type="text" class="col-md-6 form-control" placeholder="Agregar Cantidades" aria-label="Username" aria-describedby="basic-addon1">
              ...
              <div class="input-group mb-3">
                ...
                <input type="date" class="col-md-8 form-control" placeholder="Escriba una Fecha" aria-label="Username" aria-describedby="basic-addon1">
